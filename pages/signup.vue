    ...
    <v-container fluid class="codeout-content-area py-sm-16 px-sm-16 pt-10 pb-10 px-6">
      <v-row class="justify-center">
        <v-card width="100%" max-width="490" class="ma-6 pa-10">
          ...
          <v-btn @click="signUp" class="codeout-btn-size-large codeout-btn-a mt-10 mb-10 v-btn v-btn--is-elevated v-btn--has-bg"><i class="codeout-icon"><v-img :src="`${$config.assetsDomain}/images/icon_github.svg`"></v-img></i>GitHubアカウントで登録する</v-btn>
